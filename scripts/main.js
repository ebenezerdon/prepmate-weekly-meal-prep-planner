/* main.js - entry point that initializes the app after other scripts are loaded
   It respects the hard contract: checks for window.App and init/render existence and calls them.
*/
